-- Atomic RPC to save all lead distribution settings at once
...
BEGIN
  ...
  DELETE FROM public.lead_distribution_settings;
  ...
  -- Success! The trigger on lead_distribution_settings will handle ticket regeneration.
END;
$$;

-- Grant execution permissions
GRANT EXECUTE ON FUNCTION public.save_lead_distribution_settings(JSONB) TO authenticated;
